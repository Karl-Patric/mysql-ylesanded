SELECT * FROM d110079_raamatud.books WHERE release_date % 2 = 0;
SELECT count(*), language FROM d110079_raamatud.books GROUP BY language ORDER BY count(*) desc LIMIT 3;
...
(SELECT id FROM d110079_raamatud.clients WHERE username = "mcage1o"),
(SELECT id FROM d110079_raamatud.books WHERE title = "Vendetta"));
UPDATE d110079_raamatud.books
